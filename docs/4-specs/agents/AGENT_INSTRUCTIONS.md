...
<!-- AGENT_CONTEXT
Purpose: System prompt and execution protocol for autonomous agents implementing Golden Path
Authoritative: Yes
Keywords: agent, instructions, golden_path, execution, protocol, constraints, enumeration
Depends_On: 3-implementation/golden-path/GOLDEN_PATH_IMPLEMENTATION_GUIDE.md
Used_By: agents, developers
Status: current
